...
export default function Login() {
  ...
  return (
    <div className={`relative min-h-screen overflow-y-auto font-sans flex flex-col justify-center items-center p-6 transition-all duration-500 bg-gradient-to-br ${isLight ? 'from-[#f7f3eb] to-[#e8e0d4] text-[#111111]' : 'from-[#000000] to-[#071a26] text-white'}`}>
          ...
          <div className="space-y-1">
            <div className="relative">
              <input 
                ...
                className={`w-full border rounded-xl pl-5 pr-12 py-4 focus:outline-none focus:border-[#00ffd5] focus:ring-1 focus:ring-[#00ffd5] transition-all placeholder-slate-500 ${isLight ? 'bg-white/40 border-slate-300 text-[#111111]' : 'bg-white/12 text-white'}`}
              />
              <button
                type="button"
